/*
 *	ChainToNum - Convert a Thesaurus of the Gods chain file to a single numeric value and print that number to stdout.
 *
 *	D.Merrell - 2/19/20
 *
 *	gcc -m64 -o ChainToNum ChainToNum.c -lgmp
 */
