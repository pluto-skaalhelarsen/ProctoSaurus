...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ProctoSaurus Demo saurus file build
// female, male, last, cities, groceries
...
//..........
  for(i=0; i < 3; i++)
  {
    if(!RandomizeIndexEntries(SaurusArray[i].HeadIndex, SaurusArray[i].HeadIndexCnt))
    {
      printf("Attempt to randomize index %d failed\n", i);
      return(-1);
    } // if
  } // for
  ...
  {
    if(!XformIndexToFullPartition(&SaurusArray[i]))
    {
      printf("Attempt to transform index %d failed\n", i);
      return(-1);
    } // if
  } // for
  ...
  if(!SaveAllToMultiIndexFile(SaurusArray, SaurusArrayCnt, "ProctoDemo.saurus.txt"))
  {
